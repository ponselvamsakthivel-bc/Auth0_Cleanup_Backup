...
{ 
  ...
  console.log(context.webtask.secrets.TEMPLATE_ID); 

  console.log(context.webtask.secrets.TEST_URL); 

  console.log(context.webtask.secrets.XAPI_KEY); 
  ...
  { 
        ...
        url: context.webtask.secrets.TEST_URL, 
